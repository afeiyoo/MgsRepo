...
QString DataServiceMysql::getSuccessedTradesSql(int vehicleIdentifyType, QString vehPlate, QString cardID, int dataType, int judgeTime) const
{
...
QString DataServiceMysql::getShiftCntSql(const QString &shiftDate, int shiftID, int laneID, int flag) const
{
    QString sql;
    if (flag == 1) {
